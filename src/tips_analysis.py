...
filename = 'yellow_tripdata_2015-04.csv'  # Name of the file
file_type = TaxiType.YELLOW  # Type of taxi
period = '2015-04'  # Period recorded in data
...
tips_per_time = df.groupBy(dayofyear(do_time).alias('day_of_year')).avg(tip).orderBy('avg(' + tip + ')',
                                                                                     ascending=False)
tips_per_time.show(10)
