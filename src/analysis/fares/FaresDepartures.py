...
class FaresDepartures:
    spark = SparkSession \
        .builder \
        .appName("max-fares-departures") \
        .getOrCreate()

    yellow_data_path = os.path.join(os.path.dirname(__file__), "output-data/yellow-fares-departures")
    green_data_path = os.path.join(os.path.dirname(__file__), "output-data/green-fares-departures")
...
aa = FaresDepartures(reader)  # Set the reader
