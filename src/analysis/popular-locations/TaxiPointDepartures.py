...
class TaxiPointDepartures:
    ...
    yellow_data_path = os.path.join(os.path.dirname(__file__), "output-point-data/yellow-departures")
    green_data_path = os.path.join(os.path.dirname(__file__), "output-point-data/green-departures")
...
aa = TaxiPointDepartures(reader)  # Set the reader
